...
let AccountComponent = class AccountComponent {
    ...
    getuserlist(username) {
        this.httpClient.post("http://localhost:3000/getuserlist", username).subscribe(res => {
            var userdetails = JSON.parse(localStorage.getItem("currentUser"));
    ...
    createNewUser() {
        if (this.nofgroupadmin != "" && this.nusername != "" && this.nage != "" && this.nbirthdate != "" && this.nemail != "" && this.npassword != "" && this.nusername != "super") {
            ...
            this.httpClient.post("http://localhost:3000/createuser", body).subscribe(res => {
                if (res.err) {
                    alert(res.err);
                }
                else {
    ...
    removeUserFromGroup() {
        ...
        this.httpClient.post("http://localhost:3000/removeuserfromgroup", removeuser).subscribe(res => {
            alert(res.notice);
            this.groupDetail(this.detailedgroup.groupname);
        });
    }
    ...
    createChannel() {
        if (this.nchannelname) {
            ...
            this.httpClient.post("http://localhost:3000/createchannel", newchannel).subscribe(res => {
                if (res.notice == "Done") {
    ...
    deleteChannel(channel) {
        ...
        this.httpClient.post("http://localhost:3000/deletechannel", deletechannel).subscribe(res => {
            if (res.notice == "Done") {
    ...
    addUserToChannel() {
        if (this.cusername != "" && this.addtochannelname != "") {
            ...
            this.httpClient.post("http://localhost:3000/addusertochannel", adduser).subscribe(res => {
                alert(res.notice);
                this.groupDetail(this.detailedgroup.groupname);
            });
        }
